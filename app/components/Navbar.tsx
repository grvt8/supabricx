    ...
    <>
      <nav className="w-full h-20 p-4 text-white flex justify-around items-center cursor-pointer">
        <div className="flex justify-center items-center h-full w-fit">
          <Image src="/logo2.png" alt="Logo" className="h-15 w-15" width={100} height={10} />
          <p className="text-2xl">Supabricx</p>
        </div>
        <div className="flex justify-evenly items-center h-full w-100 bg-white/5 backdrop-blur-md border border-white/10 shadow-lg">
          <p>Product</p>
          <p>Docs</p>
          <p>APIs</p>
        </div>
